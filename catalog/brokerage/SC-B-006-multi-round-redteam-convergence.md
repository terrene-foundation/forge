...
journal_evidence:
  - path: loom/journal/0034-RISK-stack-gaps-redteam-attack.md
    polarity: POSITIVE
    quote: "The 17-workspace plan across 5 phases is structurally sound in its dependency ordering but contains three critical and five major risks that could extend the estimated 8 autonomous days to 14-20 days."
  - path: loom/journal/0039-DECISION-redteam-round3-convergence.md
    polarity: POSITIVE
    quote: "Round 3 verified all ~23 findings from Rounds 1-2 plus 9 specific consistency checks. Found 3 gaps. All resolved below."
...
- SC-B-014 (explicit supersession journaling) — red team rounds are the primary source of decision reversals that require explicit supersession references in the journal.
- SC-P-015 (ask for contradictions) — ending red team prompts with "what would invalidate this?" produces adversarial rather than confirmatory findings in each round.
