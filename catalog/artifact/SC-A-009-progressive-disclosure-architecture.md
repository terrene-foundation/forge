...
journal_evidence:
  ...
  - path: loom/journal/0018-DECISION-cc-audit-convergence.md
    polarity: POSITIVE
    quote: "- nexus-specialist 497\u2192144 lines (extracted to skills/03-nexus/)\n- kaizen-specialist 411\u2192302 lines (extracted to skills/04-kaizen/)"
...
- SC-A-010 (token budget baked vs external) — the 4-level hierarchy is the external side of the token-budget boundary; baked rules sit below the hierarchy as compiled infrastructure.
- SC-A-015 (Layer 2 context structuring) — the 4-level hierarchy is the vertical structure; SC-A-015 covers the horizontal classification into artifact types at each level.
...
- SC-P-011 (audit categorization progressive disclosure) — the audit method must understand the hierarchy's discovery mechanisms; counting "referenced by name" misses skills discovered via globs.
