...
- SC-B-002 (authority-chain escalation) — when a rename in an upstream repo produces dangling references in downstream repos, the sweep must be escalated to the upstream layer.
