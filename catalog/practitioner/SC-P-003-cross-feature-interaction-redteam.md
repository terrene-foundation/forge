...
- SC-B-008 (convergence-as-validation) — cross-feature interactions are a common source of convergent findings when independent red team agents probe different feature boundaries.
- SC-P-010 (timing race condition red team) — timing failures are a specific class of cross-feature interaction where two individually correct subsystems produce incorrect behaviour when they run concurrently.
