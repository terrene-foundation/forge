...
- SC-P-024 (fallback permanence detection) — parallel principle: the second consumer of a workaround triggers permanence intervention, just as the second occurrence of a drift class triggers structural intervention
