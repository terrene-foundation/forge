...
| `drills/`                              | **57 drill specs + 67 fully expanded exemplars**. `specs/` holds one structured drill spec per COC atom. `exemplars/` holds 67 full-form drills (57 COC + 10 COR) with setup, task, model answer, scoring, and extensions. `README.md` indexes by craft area, modality, difficulty, and spec lineage. |
