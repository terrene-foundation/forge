...
journal_evidence:
  - path: loom/journal/0004-RISK-learning-system-broken.md
    polarity: NEGATIVE
    quote: "4,579 observations in kailash-py, 99% are infrastructure noise (session start/stop). 8 instincts generated, all 'workflow_builder pattern' with hardcoded 0.9 confidence."
