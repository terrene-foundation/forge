...
journal_evidence:
  - path: loom/kailash-py/workspaces/data-fabric-engine/journal/0001-DECISION-dataflow-extension-not-separate-package.md
    polarity: POSITIVE
    quote: "Ship the data fabric engine as an optional extension of `kailash-dataflow`, installed via `pip install kailash-dataflow[fabric]`. Code lives in `packages/kailash-dataflow/src/dataflow/fabric/`."
