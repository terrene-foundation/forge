...
journal_evidence:
  - path: loom/journal/0034-RISK-stack-gaps-redteam-attack.md
    polarity: POSITIVE
    quote: "Split B0 into two deliverables with independent gates: B0a: Extract HandlerRegistry + EventBus as standalone modules (1 session). This unblocks WS-2A immediately. B0b: Extract HTTPTransport + MCPTransport as Transport implementations (2-3 sessions). This can run in parallel with Phase 2 work that only needs the registry."
